...
<html>
    ...
    <body>
       ...
       <div class="container flex justify-between items-center mb-5 py-3 mx-auto">
           <h1 class="text-3xl">New appointment </h1>
       ...
       <div class="container mx-auto flex justify-center items-center">
          <form class="w-4/5" action="/MediCare/appointment/patient/create" method="POST">
              <div class="grid grid-cols-10 gap-3">
                ...
                <div class="w-full col-span-10">
                      ...
                      <c:if test="${errors != null}">
                          <c:forEach var="err" items="${errors}" >
                              <c:if test="${err.errorField == 'motif'}">
                                  <p class="text-red-500 text-xs italic">
                                      <c:out value="${err.errorMessage}" />
                                  </p>
                              </c:if>
