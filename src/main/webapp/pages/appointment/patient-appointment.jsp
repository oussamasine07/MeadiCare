...
<html>
    ...
    <body>
       ...
       <div class="container flex justify-between items-center mb-5 py-3 mx-auto">
           <h1 class="text-3xl">All appointments patient</h1>
           <a href="/MediCare/appointment/patient/create" class="btn bg-blue-700 block py-3 px-6 font-bold text-white rounded">New Appointment</a>
       </div>

       <div class="container mx-auto my-4 flex justify-center items-center">
            <form class="w-4/5" action="/MediCare/appointment/patient" method="GET">
